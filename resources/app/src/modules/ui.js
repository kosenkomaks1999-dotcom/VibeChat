...
export class UIManager {
  ...
  initElements() {
    ...
    const ids = [
      ...
      "connectionStatus", "clearChatBtn", "openWhiteboardBtn", "confirmDialog", "confirmDialogMessage",
      ...
      "checkUpdateBtn", "updateStatus", "updateStatusText", "downloadUpdateBtn", "forceUpdateBtn"
    ];
